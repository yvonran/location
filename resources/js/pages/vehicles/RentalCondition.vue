...
function submit() {
    ...
    })).put(update(props.vehicle.id).url);
}
</script>
        ...
        <form class="space-y-8" @submit.prevent="submit">
            <section class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    ...
                    <div class="grid gap-2">
                        <Label for="suburb_max_km"
                            >Périphérie — jusqu'à (km)</Label
                        >
                        <Input
                            id="suburb_max_km"
                            type="number"
            ...
            <section class="space-y-4">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Pour chaque zone, définissez un tarif par tranche de
                        durée. Laissez « jusqu'à » vide pour une tranche sans
                        limite haute.
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        <div class="grid gap-1">
                            ...
                            <InputError
                                :message="
                                    errors[`rates.${entry.index}.min_days`]
                                "
                            />
                        </div>
                        ...
                        <div class="grid gap-1">
                            ...
                            <InputError
                                :message="
                                    errors[`rates.${entry.index}.max_days`]
                                "
                            />
                        </div>
                        ...
                        <div class="grid gap-1">
                            ...
                            <Input
                                ...
                                step="0.01"
                                :model-value="
                                    entry.rate.daily_rate ?? undefined
                                "
                                @update:model-value="
                                    (v) =>
                            ...
                            <InputError
                                :message="
                                    errors[`rates.${entry.index}.daily_rate`]
                                "
                            />
                        </div>
